...
from api import arxiv_search, format_convert, admin
...
@app.get("/", tags=["Root"])
def read_root():
    return {"message": "Welcome to the LaTeX Format Converter API. Visit /docs for API documentation."}


# --- 启动器 ---
if __name__ == "__main__":
    print("="*60)
    print("启动 LaTeX 格式转换 Web 服务 (版本 2.0)...")
